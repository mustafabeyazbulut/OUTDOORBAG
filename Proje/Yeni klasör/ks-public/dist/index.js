...
let MyButton = (_dec = customElement("ex-button"), _dec2 = property(), _dec3 = property(), _dec4 = property({
  ...
  render() {
    const classes = ["ex-button", this.type ? `ex-button--${this.type}` : "", this.disabled ? "ex-button--disabled" : "", this.size ? `ex-button--size-${this.size}` : ""].join(" ");
    return html`
...
}), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "disabled", [_dec4, _dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function () {
